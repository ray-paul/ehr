      ...
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          <div className="flex items-center mb-4">
            ...
            <h2 className="text-xl font-bold text-white">EHR System</h2>
          </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li>
              <Link to="/patients" className="text-gray-300 hover:text-white transition-colors duration-200">
                Patient Records
              </Link>
            </li>
            <li>
              <Link to="/appointments" className="text-gray-300 hover:text-white transition-colors duration-200">
                Appointments
              </Link>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-300">
            <li className="flex items-center">
              ...
              <a href="mailto:support@ehrsystem.com" className="hover:text-white transition-colors duration-200">
            ...
            <li className="flex items-center">
              ...
              <a href="tel:+2635551234357" className="hover:text-white transition-colors duration-200">
                +263 (555) 123-HELP
              </a>
            </li>
            <li className="flex items-center">
              ...
              <span className="font-medium text-blue-400">Emergency:</span>
