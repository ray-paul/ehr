...
const Notifications = () => {
  ...
  // SAFE: Ensure notifications is an array before using .filter()
  ...
  const criticalCount = safeNotifications.filter(n => n.priority === 'critical' && !n.is_read).length;
      ...
      <div className="min-h-screen bg-gray-50 py-8">
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">Error Loading Notifications</h3>
  ...
  return (
    <>
      <Helmet>
        <title>Notifications | EHR System</title>
